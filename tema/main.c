...
void deleteCarByManufacturer(DLList* list, const char* manufacturer) {
	if (!list->start) {
		printf("List is empty\n");
		return;
	}
...
int main() {
	...
	printf("-------------------\n");
	printf("Deleting cars from manufacturer: Mercedes\n");
	deleteCarByManufacturer(&list, "Mercedes");
